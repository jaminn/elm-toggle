...
var $author$project$Main$Model = function (toggleList) {
...
var $author$project$Main$ToggleClicked = function (a) {
	return {$: 'ToggleClicked', a: a};
};
...
var $author$project$UIElement$toggle = function (isSelected) {
	var widthVal = 60;
	var heightVal = 20;
	var translateXConditional = isSelected ? $rtfeldman$elm_css$Css$translateX(
		$rtfeldman$elm_css$Css$px(widthVal - heightVal)) : $rtfeldman$elm_css$Css$translateX(
		$rtfeldman$elm_css$Css$px(0));
	var backgroundColorConditional = isSelected ? $rtfeldman$elm_css$Css$backgroundColor(
		A3($rtfeldman$elm_css$Css$rgb, 0, 113, 210)) : $rtfeldman$elm_css$Css$backgroundColor(
		A3($rtfeldman$elm_css$Css$rgb, 202, 202, 202));
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$px(widthVal)),
						$rtfeldman$elm_css$Css$height(
						$rtfeldman$elm_css$Css$px(heightVal)),
...
var $author$project$Main$toggleListView = function (toggleList) {
	var _v0 = A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, toggleList);
	if (!_v0.b) {
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Main$ToggleClicked(0))
								]),
							_List_fromArray(
								[
									$author$project$UIElement$toggle(hd)
								]))
						]),
						A2(
						$elm$core$List$map,
						function (_v2) {
							...
							return A2(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Events$onClick(
										$author$project$Main$ToggleClicked(i)),
										$rtfeldman$elm_css$Html$Styled$Attributes$css(
										_List_fromArray(
											[
								...
								_List_fromArray(
									[
										$author$project$UIElement$toggle(t)
									]));
						},
						tl)
					])));
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$toggleListView(model.toggleList)
			]));
};
